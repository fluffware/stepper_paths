...
impl SvgPlot {
    ...
    pub fn add_line(&mut self, p1: Point, p2: Point) {
        self.lines.push(format!(
            r#"<line x1="{}" y1="{}" x2="{}" y2="{}"  style="stroke:{};fill:none"/>"#,
    ...
    pub fn add_bezier(&mut self, p1: Point, c1: Point, c2: Point, p2: Point) {
        self.lines.push(format!(
            r#"<path d="M{},{} C{},{} {},{} {},{}" style="stroke:{};fill:none"/>"#,
            p1.x, p1.y, c1.x, c1.y, c2.x, c2.y, p2.x, p2.y, self.color
        ));
    }
    ...
    pub fn add_vector(&mut self, p1: Point, p2: Point) {
        ...
        self.lines.push(format!(
            ...
            a0.x, a0.y, a1.x, a1.y, a2.x, a2.y, self.color
        ));
        self.lines.push("</g>".to_string());
    }
